            ...
            try {
              ...
              return addCorsHeaders(
                new Response(null, {
                  status: 302,
                  headers: {
                    Location: `https://www.vegvisr.org/login?email=${encodeURIComponent(parsedBody.email)}&token=${encodeURIComponent(jwtToken)}`
...
// .wrangler/tmp/bundle-0xUC9A/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-0xUC9A/middleware-loader.entry.ts
