  ...
  try {
    ...
    const tokenResponse = await fetch("https://oauth2.googleapis.com/token", {
      ...
      body: JSON.stringify({
        ...
        redirect_uri: request.url.includes("localhost") || request.url.includes("127.0.0.1") ? "http://127.0.0.1:8789/auth/google/callback.html" : "https://api.vegvisr.org/auth/google/callback.html"
      })
    });
...
// .wrangler/tmp/bundle-NKyVbh/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-NKyVbh/middleware-loader.entry.ts
