  ...
  <div class="admin-page">
    ...
    <div class="form-section">
      ...
      <textarea
        id="JsonEditor"
        v-model="graphJson"
        style="width: 100%; height: 300px; font-family: monospace; white-space: pre-wrap"
      ></textarea>
      <button @click="updateGraphFromJson" style="margin-top: 10px">Update Graph from JSON</button>
    </div>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-md-8" style="height: 100vh; padding: 20px">
          ...
          <!-- Buttons and History List -->
          <div class="row" style="margin-bottom: 10px; align-items: center">
            <div class="col-md-6">
              <button @click="centerAndZoom" style="margin-right: 10px">Center and Zoom</button>
            </div>
            <div class="col-md-6">
          ...
          <div class="row" style="margin-bottom: 10px">
            <div class="col-md-6">
              <button @click="updateGraphView" style="margin-right: 10px">Update Graph</button>
...
const selectedHistoryIndex = ref(-1) // Track the currently selected history index
...
onMounted(() => {
  ...
  cyInstance.value = cytoscape({
    ...
    layout: {
      name: 'preset', // Use 'preset' layout to avoid recalculating positions
    },
    boxSelectionEnabled: true,
  })

  // Debounce layout updates to reduce frequent recalculations
  ...
  cyInstance.value.on('dragfree', 'node', (event) => {
    ...
    updateLayout() // Debounced layout update
  })
...
const handleHistoryKeydown = (event) => {
  ...
  if (event.key === 'ArrowDown') {
    ...
    selectHistoryVersion(selectedHistoryIndex.value) // Trigger selection
...
// Ensure the selected history item is visible in the scrollable list
...
// Select a history version by index
...
const onHistoryItemClick = (index) => {
  selectedHistoryIndex.value = index // Update the selected index
  selectHistoryVersion(index) // Trigger the graph view update
}
