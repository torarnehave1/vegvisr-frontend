class KnowledgeGraphViewer extends HTMLElement {
      ...
      <div class="graph-container">
        <div class="controls">
          ...
          <div class="control-group">
            ...
            <button id="saveWithHistoryBtn" title="Save Graph with History">📚 Save with History</button>
  ...
  setupEventListeners() {
    ...
    const saveWithHistoryBtn = this.shadowRoot.getElementById('saveWithHistoryBtn')
    ...
    if (saveWithHistoryBtn) saveWithHistoryBtn.addEventListener('click', () => this.saveGraphWithHistory())
