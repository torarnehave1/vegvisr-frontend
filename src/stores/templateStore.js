...
export const useTemplateStore = defineStore('template', () => {
  ...
  const nodeTemplates = ref([
    ...
    },
    {
      ...
      description: 'Embed Cloudflare Stream videos',
      template: {
        type: 'cloudflare-video',
        label: 'Cloudflare Video',
        info: 'Edit to add a Cloudflare Stream video ID in the path field.',
        color: '#fff3e0',
        visible: true,
        position: { x: 100, y: 100 },
        path: null,
    ...
    },
    {
      ...
      category: 'Visual Elements',
      icon: '📡',
      label: 'Cloudflare Live Stream',
      description: 'Live stream via Cloudflare Stream (RTMP/SRT)',
      template: {
        type: 'cloudflare-live',
        label: 'Live Stream',
        info: 'Configure RTMP credentials in metadata. Set video ID in path when stream starts.',
        color: '#ffebee',
        visible: true,
        position: { x: 100, y: 100 },
        path: null,
