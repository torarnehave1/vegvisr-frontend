  ...
  try {
    cyInstance.value = cytoscape({
      ...
      style: [
        ...
        {
          selector: 'node[type="portfolio-image"]',
          style: {
            shape: 'rectangle',
            ...
            'border-color': '#4a90e2',
            'border-style': 'solid',
            width: (ele) => `${ele.data('imageWidth')}px`,
            height: (ele) => `${ele.data('imageHeight')}px`,
            'z-index': 1,
        ...
        },
        {
          ...
          style: {
            ...
            'border-color': '#667eea',
            'border-style': 'solid',
            width: (ele) => (ele.data('imageWidth') ? `${ele.data('imageWidth')}px` : '800px'),
            height: (ele) => (ele.data('imageHeight') ? `${ele.data('imageHeight')}px` : '600px'),
            'z-index': 2,
            label: (ele) => ele.data('label') || '',
            'text-valign': 'center',
            'text-halign': 'center',
            'text-background-color': 'rgba(102, 126, 234, 0.7)',
            ...
            'text-wrap': 'wrap',
            'text-max-width': (ele) => `${parseInt(ele.data('imageWidth')) - 100}px`,
          },
        },
        ...
        {
          selector: 'node[type="linechart"]',
          style: {
            shape: 'rectangle',
            'background-image': '/images/linechart.png',
            'background-fit': 'cover',
        ...
        {
          selector: 'node[type="bubblechart"]',
          style: {
            shape: 'rectangle',
            'background-image': '/images/bubblechart.png',
            'background-fit': 'cover',
