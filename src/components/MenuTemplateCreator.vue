<template>
  <div class="menu-template-creator">
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="form-group">
              ...
              <select id="buttonStyle" v-model="menuConfig.style.buttonStyle" class="form-control">
          ...
          <div v-for="(item, index) in menuConfig.items" :key="index" class="menu-item-editor">
            ...
            <div class="row">
              <div class="col-md-3">
                <div class="form-group">
                  <label>ID</label>
                  <input v-model="item.id" type="text" class="form-control" placeholder="item-id" />
                </div>
              </div>
              <div class="col-md-3">
                <div class="form-group">
